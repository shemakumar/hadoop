...
dpkg -b deb flipkart-hadoop-source-tar-repo-test.deb
reposervice --host 10.24.0.41 --port "8080" pubrepo --repo  fk-hadoop-source-tar-repo-test  --appkey dummy --debs flipkart-hadoop-source-tar-repo-test.deb
cd $cwd